...
var i = require("./A02C1207DFE146BFC64A7A00113A66E3"), s = require("./38A05F86DFE146BF5EC63781B6CC66E3"), u = require("./9D37ECA4DFE146BFFB5184A3CEFC66E3"), d = require("./69F364A2DFE146BF0F950CA5BF9D66E3"), c = require("./82AAE8D4DFE146BFE4CC80D36C4A66E3"), l = [ {
    text: "全部",
    selected: !0
}, {
    text: "待付款",
    ...
    return o(e, t), e.prototype.onLoad = function(e) {
            ...
            return a(this, function(a) {
                switch (a.label) {
                  case 0:
                    ...
                    10 === e && 3 === this.statusIndex ? this.loadPaging.params.shipMode = 2 : 10 === e ? this.loadPaging.params.shipMode = 1 : 11 === e ? this.loadPaging.params.shipMode = 2 : 12 === e ? this.loadPaging.params.shipMode = 1 : delete this.loadPaging.params.shipMode, 
                  ...
                  case 1:
                    for (o = a.sent(), r = 0, n = o.list; r < n.length; r++) for (i = n[r], s = 0, u = i.orderDetailList; s < u.length; s++) (d = u[s]).shipMode = i.orderInfo.shipMode, 
                    d.paymentMode = i.orderInfo.paymentMode, d.status = i.orderInfo.status, d.remark = i.orderInfo.remark, 
                    d.orgName = i.orgInfo.orgName;
                    return o && (t && (this.scrollTop = 0), this.noMore = !o.hasMore, this.list = o.list), 
                    [ 2 ];
                }
            });
        });
        ...
        return n(this, void 0, void 0, function() {
            ...
            return a(this, function(n) {
                return e = t.detail, o = e.orderId, r = e.type, d.go("/pages/confirm_order/confirm_order?index=" + r + "&orderId=" + o + "&from=" + c.Constant.ORDER_FROM_ORDER_LIST), 
                [ 2 ];
            });
        });
    ...
    r([ s.Data(-1) ], e.prototype, "statusIndex", void 0), e;
}(i.default);
