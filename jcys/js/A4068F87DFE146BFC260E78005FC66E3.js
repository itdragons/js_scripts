!function() {
    ...
    var M = null, R = {
        ...
        draw: function(r, f, e, t, a, n) {
            if (b = n || b, f = f || M) {
                var i = Math.min(e, t);
                r = this.utf16to8(r);
                var c = this.getFrame(r), s = wx.createCanvasContext(f, a), l = Math.round(i / (o + 8)), u = l * (o + 8), v = Math.floor((i - u) / 2);
                i = u, s.setFillStyle("#ffffff"), s.fillRect(0, 0, e, e), s.setFillStyle("#000000");
                for (var h = 0; h < o; h++) for (var d = 0; d < o; d++) c[d * o + h] && s.fillRect(l * (4 + h) + v, l * (4 + d) + v, l, l);
                s.draw();
